            ...
            <main className="flex-1 w-full p-6 lg:p-12 xl:p-20 overflow-y-auto">
                <div className="max-w-[900px]">
                    ...
                    <div className="mb-12">
                        <Link
                            to="/"
                            className="inline-flex items-center gap-2 text-sm font-semibold text-gray-500 dark:text-gray-400 hover:text-primary transition-colors mb-6"
                        >
                            ...
                            <div className="flex gap-3">
                                {meta.links?.github && (
                                    <a
                                        ...
                                        className="p-2.5 rounded-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-gray-600 dark:text-gray-400 hover:text-primary hover:border-primary transition-all shadow-sm"
                    ...
                    <footer className="mt-24 pb-8 text-center text-sm text-[#616f89] dark:text-gray-500">
                        <p>
                            © 2025 DoHyeon. All rights reserved.
                        </p>
                    </footer>
                </div>
            </main>
